...
(2, 26, '2026-04-24 23:40:00', '2026-04-24 15:32:56', '2026-04-24 15:32:56');
...
(23, 'qb202102102@wmsu.edu.ph', '$2b$10$8bt36e4jy2k9kDvCmAmtNeCwDawPAzdbtPvRnLz3bNB9WiDb.TpSa', 'karlos', 'valero', 'B', 'Dean', 'approved', 1, '2026-04-20 05:20:37', NULL),
(24, 'valerocarlos030@gmail.com', '$2b$10$eVmALQHbe5XeCFDAnojZVO1RyvwIN4bSjMPERw.rpvA.ndXaG/NBC', 'karlos', 'bongcasan', 'S', 'QA Coordinator', 'approved', 1, '2026-04-20 11:32:28', NULL),
(26, 'camperbongcasan@gmail.com', '$2b$10$T/6G9nKBLkdr331bFe80t.WdKYZwPa0LEQPAZ6/F5S58ctptqmjOS', 'camper', 'valero', 'B', 'evaluator', 'approved', 1, '2026-04-24 15:32:56', NULL);
...
ALTER TABLE `document_approval_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_approval_document_id` (`document_id`),
  ADD KEY `idx_approval_reviewer_id` (`reviewer_id`);
...
--
ALTER TABLE `document_approval_logs`
  ADD CONSTRAINT `document_approval_logs_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `document_approval_logs_ibfk_2` FOREIGN KEY (`reviewer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
