...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // QA Coordinator cannot access upload.html
    if (role === 'qa coordinator') { window.location.href = 'homepage.html'; return; }
    ...
    // Hide Upload link for QA Coordinator on all pages
